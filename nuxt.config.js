...
export default {
	...
	head: {
		...
		meta: [
			...
			{ hid: 'description', name: 'description', content: '漬け焼きという独自の調理法で、「おかさなの素」をはじめとした、こだわりのお魚加工品を製造・販売している阿部守商店の公式通販・オンラインショッピングサイトです。' },
			{ name: 'format-detection', content: 'telephone=no' },
			{ property: 'og:locale', content: 'ja_JP' },
			{ property: 'og:type', content: 'website' },
			{ hid: 'og:sitename', property: 'og:sitename', content: '阿部守商店' },
			{ hid: 'og:title', property: 'og:title', content: '阿部守商店' },
			{ hid: 'og:description', property: 'og:description', content: '漬け焼きという独自の調理法で、「おかさなの素」をはじめとした、こだわりのお魚加工品を製造・販売している阿部守商店の公式通販・オンラインショッピングサイトです。' },
