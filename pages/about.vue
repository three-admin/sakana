		...
		<section class="info">
			<div id="abe-mamoru" class="shop">
				<div class="text_wrap">
					...
					<p class="description">阿部守商店は1971年創業。漁師として世界を巡り、海の色から魚の品質を見極める目を養いました。やがて魚市場で魚屋を開き、80年代には加工業に進出。より美味しく魚を食べる方法を追求する中で出会ったのが、愛知県の特産品である白醤油です。主原料に小麦を使った白醤油は甘みと香りに特徴があり、素材の味を活かすのに最適。白醤油に漬け込んでから焼き上げる独自の調理法を確立しました。創業から半世紀。魚を美味しく食べてほしいという思いは、これからも変わることはありません。</p>
				</div>
				<div class="img_wrap">
